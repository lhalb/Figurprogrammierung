...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalLayout_2.addWidget(self.gif_label)
...
"Folders"))
        ...
        item.setToolTip(_translate("Dialog", "Position (für Wahl der Reihenfolge)"))
        ...
        self.status_label.setText(_translate("Dialog", "Working..."))
        self.cb_oldfilename.setToolTip(_translate("Dialog", "Erzeugt .b00 statt .bxy Dateien (für alte MMC-Software)"))
